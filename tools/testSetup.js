...
// to simulate a browser environment for tests. So that we can test
// React components without opening the browser.
var jsdom = require('jsdom').jsdom;

// React uses the below variables to test if it is in a browser.
